...
public class travelerbackup {
    ...
    public travelerbackup(int first, matrix dist, int n) {
        this.first = first;
        this.n = n;
        this.dist = dist;
    }

    public travelerbackup(int first, matrix dist, int n, Scanner s) {
        this(first, dist, n);
        this.scanner = s;
    }

    public travelerbackup setSol(solution sol) {
        this.sol = sol;
        return this;
    }
